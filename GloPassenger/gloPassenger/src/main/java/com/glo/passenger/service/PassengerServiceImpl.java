...
public class PassengerServiceImpl implements PassengerService {
    ...
    public PassengerEventsDTO mapToEvent(Passenger passenger,String action) {
    	return PassengerEventsDTO.builder()
    			.action(action)
    			.email(passenger.getEmail())
    			.firstName(passenger.getFirstName())
    			.lastName(passenger.getLastName())
    			.passenger_id(passenger.getPassenger_id())
    			.build();
    }
    ...
    public Passenger getPassengerById(long passenger_id) throws PassengerNotFoundException {
       return  passengerRepo.findById(passenger_id).orElseThrow(() -> new PassengerNotFoundException("passenger with id: " + passenger_id + " not found"));
       
    }

    @Override
    public void deletePassengerById(long passenger_id) throws PassengerNotFoundException {
        Passenger passenger= passengerRepo.findById(passenger_id).orElseThrow(() -> new PassengerNotFoundException("passenger with id: "+ passenger_id + " not present "));
    ...
    public Passenger updatePassenger(Passenger p, long passenger_id) throws PassengerNotFoundException {
        Passenger updatePassenger = passengerRepo.findById(passenger_id).orElseThrow(() -> new PassengerNotFoundException("Passenger not exist with id: " + passenger_id));
